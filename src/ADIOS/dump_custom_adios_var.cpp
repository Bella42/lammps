...
#include "dump_custom_adios_var.h"
...
DumpCustomADIOSVar::DumpCustomADIOSVar(LAMMPS *lmp, int narg, char **arg) : DumpCustomADIOS(lmp, narg, arg)
{
    std::cout << "Yay. The call in in.first worked\n" ;
...
DumpCustomADIOSVar::~DumpCustomADIOSVar()
{
}

/* ---------------------------------------------------------------------- */

void DumpCustomADIOSVar::write()
{
...
//TODO: change memory buffer to only contain actual variable data
  if (nme > maxbuf) {
