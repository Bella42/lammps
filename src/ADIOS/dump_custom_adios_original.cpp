...
#include "dump_custom_adios_original.h"
...
DumpCustomADIOSOriginal::DumpCustomADIOSOriginal(LAMMPS *lmp, int narg, char **arg) : DumpCustomADIOS(lmp, narg, arg)
{
...
DumpCustomADIOSOriginal::~DumpCustomADIOSOriginal()
{
}

/* ---------------------------------------------------------------------- */

void DumpCustomADIOSOriginal::write()
{
